	...
	<div class="about wthree-1">
				<div class="container">
					...
					<div class="about-header">
						...
						<div class="about-1">
						 <img src="<?php echo base_url('asset/images/ab1.jpg');?>" class="img-responsive" alt="/">
						 <h4>Mauris asan nulla vel diam Sed </h4>
						 <p>Lorem ipsum dolor sit amet, consectetuer adipiscing ellente ssed dololiquam congu fermentum nisl. Mauris asan nulla vel diam. Sed in lacus ut enim adipiscing aliquetulla venenat pede mi, aliquet sit amet.</p>
						</div>
					</div>
				...
				<div class="team-info w3agile-1">
					<div class="col-md-3 team-grids agileinfo-1">
						<a href="#">
							<img class="img-responsive" src="<?php echo base_url('asset/images/t4.jpg'); ?>" alt="">
							<div class="captn">
								<h4>Tincidun</h4>
								<p>Aenean pulvinar</p>
					...
					<div class="col-md-3 team-grids agileinfo-1">
						<a href="#">
							<img class="img-responsive" src="<?php echo base_url('asset/images/t5.jpg'); ?>" alt="">
							<div class="captn">
								<h4>Velit uti</h4>
								<p>Aenean pulvinar</p>
									<ul class="social-icons1">
					...
					<div class="col-md-3 team-grids agileinfo-1">
						<a href="#">
							<img class="img-responsive" src="<?php echo base_url('asset/images/t6.jpg' ); ?>" alt="">
							<div class="captn">
								<h4>Posuere</h4>
								<p>Aenean pulvinar</p>
									<ul class="social-icons1">
					...
					<div class="col-md-3 team-grids agileinfo-1">
						<a href="#">
							<img class="img-responsive" src="<?php echo base_url('asset/images/t7.jpg');?>" alt="">
							<div class="captn">
								<h4>Augc sfe</h4>
								<p>Aenean pulvinar</p>
									<ul class="social-icons1">
					...
					<div class="container">
						...
						<div class="test-grids">
							<div class="col-md-4 test-grid">
								<p>Nullam quis enim efficitur, faucibus nunc at, rutrum lorem. Quisque molestie placerat quam vel lacinia. Donec ut lorem quis massa.</p>
								<h4>- tom james</h4>
							</div>
							<div class="col-md-4 test-grid">
								<p>Nullam quis enim efficitur, faucibus nunc at, rutrum lorem. Quisque molestie placerat quam vel lacinia. Donec ut lorem quis massa .</p>
