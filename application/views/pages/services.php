					...
					<h1>Services</h1>
							...
							<div class="col-md-4 service-grid agile-4">
								<div class="history-grid-image">
									<img src="<?php echo base_url('asset/images/1.jpg');?>" class="img-responsive zoom-img" alt="">
								</div>
							...
							<div class="col-md-4 service-grid agile-4">
							<div class="history-grid-image">
									<img src="<?php echo base_url('asset/images/3.jpg'); ?>" class="img-responsive zoom-img" alt="">
								</div>
							...
							<div class="col-md-4 service-grid agile-4">
								<div class="history-grid-image">
									<img src="<?php echo base_url('asset/images/4.jpg'); ?>" class="img-responsive zoom-img" alt="">
								</div>
								<h4>Solor Sit Amet</h4>
								<p>Were dolor in hendrerit in vulputate velit esse molestie con sequat,Nulla consectetur maximus sem vel aliquet. Donec blandit condimentum varius</p>
							</div>
							<div class="col-md-4 service-grid agile-4">
							<div class="history-grid-image">
									<img src="<?php echo base_url('asset/images/5.jpg'); ?>" class="img-responsive zoom-img" alt="">
								</div>
								<h4>Lorem Ipsum Dolor</h4>
								<p>Were dolor in hendrerit in vulputate velit esse molestie con sequat,Nulla consectetur maximus sem vel aliquet. Donec blandit condimentum varius</p>
							</div>
							<div class="col-md-4 service-grid agile-4">
							<div class="history-grid-image">
									<img src="<?php echo base_url('asset/images/6.jpg'); ?>" class="img-responsive zoom-img" alt="">
								</div>
								<h4>Pamet Erosorem</h4>
								<p>Were dolor in hendrerit in vulputate velit esse molestie con sequat,Nulla consectetur maximus sem vel aliquet. Donec blandit condimentum varius</p>
							</div>
